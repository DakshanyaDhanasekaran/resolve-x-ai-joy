    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-hero items-center justify-center p-12">
        ...
        >
          ...
          <p className="text-xl font-medium mb-4" style={{ color: "hsl(220, 15%, 85%)" }}>
            AI-Driven Complaint Management
          </p>
          <p className="text-base leading-relaxed" style={{ color: "hsl(220, 15%, 65%)" }}>
            Streamline your complaint resolution process with intelligent tracking, real-time updates, and powerful analytics.
          </p>
        </motion.div>
      </div>
        ...
        >
          ...
          {error && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="flex items-center gap-2 p-3 rounded-lg bg-destructive/10 text-destructive text-sm mb-6"
            >
          ...
          <div className="mt-8 p-4 rounded-lg bg-muted text-xs text-muted-foreground">
            ...
            <p>Admin: admin@gmail.com / any password</p>
            <p>User: any email / any password (min 4 chars)</p>
          </div>
        </motion.div>
      </div>
    </div>
